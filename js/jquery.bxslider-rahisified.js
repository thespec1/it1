...
;(function($){
	...
	var defaults = {
		...
		useMarginInViewportHeight: false,
     ...
     * ===================================================================================
      ...
      if(slider.settings.breaks) {
		...
		var getViewportHeight = function(){
			...
			// if not "vertical" mode, calculate the max height of the children
				...
				height = Math.max.apply(Math, children.map(function(){
					return $(this).outerHeight(slider.settings.useMarginInViewportHeight);
				}).get());
		...
		el.redrawSlider = function(){
			...
			tmp = el.find('.bx-clone');
			tmp.width(calcSlideWidthidth());
			slider.children.add(tmp);
